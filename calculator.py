...
entryField = Entry(root, font=('arial', 20, 'bold','italic'), bg='dodgerblue3', fg='yellow', bd=10, relief=SUNKEN, width=30)
...
for i in button_text_list:
    ...
    button = Button(root, width=5, height=2, bd=2, relief=SUNKEN, text=i, bg='dodgerblue3', fg='yellow',
                    font=('arial', 18, 'bold', 'italic'), activebackground='dodgerblue3', command=lambda button=i: click(button))
